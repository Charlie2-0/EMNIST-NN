function [J, grad, htheta] = costFunct(X, y_matrix, nntheta, lambda,funct, functgrad,hidden_layers,t_rows,t_cols,ts)
...
D{hidden_layers+1} = d{hidden_layers+2}'*a{hidden_layers+1};
%collect the grads
